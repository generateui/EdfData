...
*/
        ...
        hashMap.put("The specified hypnogram does not have the same number",
                    "L'hypnogramme spécifié ne semble pas avoir le même nombre");
        ...
        hashMap.put("The specified file can only be opened in read-only mode.",
                    "Le fichier spécifié ne peut être ouvert qu'en lecture seule.");
        hashMap.put("You are attempting to close a modified hypnogram without it being saved first.\nAre you sure you want to continue ?",
                    "Vous essayez de fermer un hypnogramme modifié sans que ce dernier ait été sauvegardé au préalable.\nEtes-vous sûr de vouloir continuer ?");
        hashMap.put("0,1,2,3,4,5,6 and 9 are Wake,1,2,3,4,REM,MT and unscored, respectively",
                    "0,1,2,3,4,5,6 et 9 correspondent respectivement à Veille,1,2,3,4,SP,MT et non scoré.");

        hashMap.put("Ready whenever you are !"
                    , "Prêt dès que vous l'êtes !");
        hashMap.put("Unable to access the specified file."
        ...
        hashMap.put("The specified file does not appear to be\nan EDF standard compliant file."
                    , "Le fichier spécifié ne semble pas être un fichier EDF conforme.");
        hashMap.put("I/O Error : please verify that you have the rights to access the specified file\nand that it is not in use by another program."
                    , "Erreur E/S : veuillez vérifier que vous aves le droit d'accéeder au fichier spécifié\net qu'il n'est pas utilisé par un autre programme.");
        hashMap.put("Epoch n° ", "Epoque n° ");
        hashMap.put("                 Hypnogram Epoch Duration : "
                    , "                 Durée de l'époque de l'hypnogramme : ");
        hashMap.put("EDF files", "Fichiers EDF");
        hashMap.put("Hypnogram", "Hypnogramme");
        ...
        hashMap.put("Please choose the signal to extract the hypnogram from :"
                    , "Veuillez choisir le signal d'où extraire l'hypnogramme :");
        hashMap.put("Extract", "Extraire");
        hashMap.put("Load from file", "Charger depuis le fichier");
        hashMap.put("Please choose an input file :"
                    , "Veuillez choisir un fichier d'entrée :");
        hashMap.put("Browse", "Parcourir");
        hashMap.put("Load", "Charger");
        hashMap.put("Please choose the desired epoch duration (in s):"
                    , "Veuillez choisir la durée d'une époque.");
        hashMap.put("New Hypnogram", "Nouvel hypnogramme");
        hashMap.put("Please choose the file to record the hypnogram to:"
                    , "Veuillez choisir le fichier où enregistrer l'hypnogramme.");
        hashMap.put("Create", "Créer");
        hashMap.put("The specified signal does not appear to contain hypnogram data."
                    , "Le signal spécifié ne semble pas contenir d'information sur l'hypnogramme.");
        hashMap.put(
                "The specified file does not appear to correspond to the currently loaded data."
                , "Le fichier spécifié ne semble pas correspondre aux données chargées.");
        hashMap.put(
                "Continuing will replace the content of the specified file.\nAre you sure you want to continue ?"
                ,
                "Continuer effacera le contenu du fichier spécifié.\nEtes-vous certain de vouloir continuer ?");
        hashMap.put("Please input an integer between 1 and 60 inclusive."
                    , "Veuillez entrer un entier entre 1 et 60 inclus.");
        hashMap.put("Cannot create the file : please specify a correct filename\nand verify that you have the rights to write to it."
                    , "Ne peux créer le fichier : veuillez spécifier un nom correct\net vérifier que vous avez le droit d'y écrire.");
        hashMap.put("Hypnogram record", "Enregistrement de l'hypnogramme");
        hashMap.put("Please verify that you have selected a correct signal input for each channel."
                    , "Veuillez vérifier que chaque chaîne ait un signal correct associé.");
        hashMap.put(
        ...
        hashMap.put("Please choose the file you want to load."
                    , "Veuillez choisir le fichier que vous souhaitez charger.");
        hashMap.put("Please choose the file you want to save to."
                    , "Veuillez choisir le fichier où vous voulez sauver.");
        hashMap.put("Please choose the wanted granularity, in seconds :",
                    "Veuillez entrer la granularité souhaitée, en secondes :");
        ...
        hashMap.put("and that you have write access on it."
                    , "et que vous avez les droits en écriture dessus.");
        hashMap.put(
        ...
        hashMap.put("Continuing will erase its content.\nAre you sure you want to continue ?"
                    , "Continuer effacera son contenu.\nEtes-vous sûr de vouloir continnuer ?");
        hashMap.put("Error : please input a correct integer value for the granularity."
                    , "Erreur : veuillez entrer une valeur entière correcte pour la granularité.");
        hashMap.put("and that you have write access on it."
                    , "et que vous avez des droits en écriture dessus.");

        hashMap.put("Informations", "Informations");

        hashMap.put("Error : the specified file does not seem to contain precise scoring data."
                    ,
                    "Erreur : le fichier précisé ne semble pas contenir de données de scorage fin.");
        ...
        hashMap.put("The operation has been completed successfully !"
                    , "L'opération s'est achevé avec succés !");
        hashMap.put("Success", "Succés");
        hashMap.put("Please verify that you have entered valid parameters."
                    , "Veuillez vérifier que vous avez entré des paramètres valides.");
        hashMap.put(
                "I/O Error : please verify that you have the right to write to the specified file."
                ,
                "Erreur E/S : veuillez vérifier que vous avez le droit d'écrire dans le fichier spécifié.");

        hashMap.put("The operation has been aborted on user request.",
                    "L'opération a été annulée à la demande de l'utilisateur.");
        ...
        hashMap.put("Go to the previous precise scoring label",
                    "Aller à l'étiquette précédente du scorage fin");
        hashMap.put("Go to the next precise scoring label",
                    "Aller à l'étiquette suivante du scorage fin");
